...
uses
  ...
  FMX.ListView.Types, FMX.ListView, FMX.MobilePreview;
...
procedure TTabletSearchForm.Edit1ChangeTracking(Sender: TObject);
var
  Lower: string;
begin
  ...
  begin
    ...
    ListView1.Items.Filter :=
      ...
      begin
        Result :=
          (Lower = EmptyStr) or LowerCase(X).Contains(Lower);
