...
{$IFDEF IOS}
  FMX.Types,
  iOSApi.MediaPlayer, iOSApi.Foundation,
{$ENDIF}
{$IFDEF ANDROID}
...
begin
  Result.Artist := TNSString.Wrap(Item.valueForProperty(MPMediaItemPropertyArtist)).UTF8String;
  Result.Album := TNSString.Wrap(Item.valueForProperty(MPMediaItemPropertyAlbumTitle)).UTF8String;
  Result.Title := TNSString.Wrap(Item.valueForProperty(MPMediaItemPropertyTitle)).UTF8String;
