...
function TMyBitmapCodec.LoadFromFile(const AFileName: string; const Bitmap: TBitmapSurface): Boolean;
var
  S: TStream;
begin
  S := TFileStream.Create(AFileName, fmOpenRead);
...
function TMyBitmapCodec.LoadFromStream(const AStream: TStream; const Bitmap: TBitmapSurface): Boolean;
var
  W, H: Integer;
  Sign: TSign;
begin
