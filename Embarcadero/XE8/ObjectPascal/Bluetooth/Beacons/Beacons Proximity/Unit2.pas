...
uses
  ...
  FMX.ListView, BeaconsRender, FMX.Objects, System.Generics.Collections;
...
begin
  ...
  case Proximity of
    TBeaconProximity.Inmediate: LProximityText := 'Inmediate';
  ...
  begin
    ...
    begin
      case Proximity of
        TBeaconProximity.Inmediate: FList.List[I].FOriginalColor := TAlphaColorRec.Green;
