...
procedure TCameraComponentForm.FormShow(Sender: TObject);
begin
Panel1.Visible := True;
end;
...
begin
  ...
  Image2.Bitmap.SetSize(imgCameraView.Bitmap.Width,imgCameraView.Bitmap.Height);
  Image2.Bitmap.Assign(imgCameraView.Bitmap);

end;

procedure TCameraComponentForm.Button1Click(Sender: TObject);
begin
Image2.Bitmap.SetSize(imgCameraView.Bitmap.Width,imgCameraView.Bitmap.Height);
...
procedure TCameraComponentForm.Button3Click(Sender: TObject);
begin
Edit1.Text := '';
