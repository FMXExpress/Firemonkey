...
private:	// User declarations
	...
	void __fastcall ReceiveThreadDataEvent(const TObject *Sender, int ThreadNo, int ASpeed, __int64 AContentLength, __int64 AReadCount, Boolean &Abort);
...
typedef void __fastcall (__closure *TThreadDataEvent)(const System::TObject* Sender, int ThreadNo, int ASpeed, __int64 AContentLength, __int64 AReadCount, Boolean &Abort);
