...
uses
  ...
  FMX.Forms3D, FMX.MaterialSources, FrameMaterial3DDesigner;
...
begin
  MainCamera.AnimateFloat('Position.Y',Maincamera.Position.Y - 1,0.2);
end;

procedure TModel3DTest.ptArrowLeftClick(Sender: TObject);
begin
  MainCamera.AnimateFloatWait('Position.X',MainCamera.Position.X +1,0.2);
end;
...
begin
  MainCamera.AnimateFloatWait('Position.Y',MainCamera.Position.Y +1,0.2);
end;
...
begin
  ...
  begin
    ...
    MaterialDesignerLayout.AnimateFloat('Width',MainLayer3D.Width);
  end
  else
...
begin
  MaterialDesignerLayout.AnimateFloat('Width',0);
end;
