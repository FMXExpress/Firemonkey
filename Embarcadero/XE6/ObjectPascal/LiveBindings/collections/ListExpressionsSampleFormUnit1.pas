...
uses
  ...
  Fmx.Bind.DBEngExt, System.Bindings.Outputs, FMX.ListBox, FMX.Layouts, SampleCollections, FMX.StdCtrls, FMX.Styles,
...
begin
  ...
  try
    ...
    begin
      ...
      FBindSource.DataObject := LDataObject;
    end
    else
      FBindSource.DataObject := nil;
  finally
    FChanging := False;
    UpdateDisplayFields;
  end;
...
begin
  // Create data source for binding to lists
  FBindSource := TBindScope.Create(Self);
  BindList1.SourceComponent := FBindSource;
