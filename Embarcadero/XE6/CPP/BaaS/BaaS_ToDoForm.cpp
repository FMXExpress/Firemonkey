...
{
	if((!FBindSourceAdapter->Modified)||(MessageDlg("Cancel changes?",
		TMsgDlgType::mtConfirmation, TMsgDlgButtons() << TMsgDlgBtn::mbOK << TMsgDlgBtn::mbCancel, 0)!=mrCancel)){
...
void __fastcall TKinveyToDoList::ActionDeleteExecute(TObject *Sender)
{
	...
	if(MessageDlg(Format("Delete \"%s\"?", ARRAYOFCONST((LTitle))),
		TMsgDlgType::mtInformation,
		TMsgDlgButtons() << TMsgDlgBtn::mbOK << TMsgDlgBtn::mbCancel , 0) != mrCancel)
	{
