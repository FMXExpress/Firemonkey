...
begin
  ...
  //LDevices := FBluetoothManager.GetPairedDevices();
  LEDevice := FBluetoothManagerLE.LastDiscoveredDevices[0];
  //LDevice := LDevices[lbPaired.ItemIndex] as TBluetoothDevice;
...
begin
  UpdateTextAndSwitch;
  Memo1.Lines.Add('MyReadEvent ' + ACharacteristic.UUIDName); // + ' Value: ' + BytesToString(ACharacteristic.Value));
end;
