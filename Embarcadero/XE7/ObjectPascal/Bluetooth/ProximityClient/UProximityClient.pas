...
const
//  ProximityDeviceName = 'esmacrosarioc01';
  CProximityDeviceName = 'Bluetooth LE Service';
...
begin
  ...
  //if cbbDevice.Selected.Text>'' then ProximityDeviceName := cbbDevice.Selected.Text;
  DoScan;
end;
...
begin
  ...
  for I := 0 to FBLEManager.LastDiscoveredDevices.Count - 1 do
      if FBLEManager.LastDiscoveredDevices[I].DeviceName = ProximityDeviceName then begin
