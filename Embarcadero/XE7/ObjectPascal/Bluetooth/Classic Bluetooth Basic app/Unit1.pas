...
begin
  ...
  Tthread.Synchronize(nil, procedure begin ComboBoxServices.DropDown end);
end;
...
begin
 ...
 // Tthread.Synchronize(nil, procedure begin ComboboxDevices.DropDown end);
end;
...
begin
  ButtonCloseReadingSocketClick(Sender);
end;
