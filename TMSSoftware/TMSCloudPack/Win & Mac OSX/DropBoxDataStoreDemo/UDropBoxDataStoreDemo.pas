...
uses
  ...
  FMX.Layouts, FMX.Grid, FMX.TMSCloudListView;
...
type
  TForm12 = class(TForm)
    ...
    procedure lvdatastoresClick(Sender: TObject);
  private
...
begin
  ...
  TMSFMXCloudDropBoxDataStore1.PersistTokens.Key := ExtractFilePath(Paramstr(0)) + 'dropboxdatastore.ini';

  ToggleControls;
end;

procedure TForm12.lvdatastoresClick(Sender: TObject);
begin
  cbRow.Items.Clear;
  edField1.Text := '';
  edField2.Text := '';
