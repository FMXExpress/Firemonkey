...
uses
  ...
  FMX.Layouts, FMX.ListBox, IOUTils, System.Rtti, FMX.Grid, FMX.TMSCloudListView,
...
type
  TForm98 = class(TForm)
    ...
    procedure lstvTaskListsChange(Sender: TObject);
...
procedure TForm98.lstvTaskListsChange(Sender: TObject);
begin
  GetTasksList;
end;
